...
## 6. Project Validation Boundary

This repository does not keep static proof packs as product evidence. Verifier correctness must be validated through real StelaKey proof artifacts produced from the connected-wallet flow before any user-facing success claim is made.
